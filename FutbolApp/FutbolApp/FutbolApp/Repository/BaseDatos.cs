...
namespace FutbolApp.Repository
{
    public class BaseDatos
    {
        ...
        public void Conectar()
        {
            ...
            Conexion = new SQLiteConnection(_rutaBD, SQLite.SQLiteOpenFlags.ReadWrite |
                                                     SQLite.SQLiteOpenFlags.Create |
                                                     SQLite.SQLiteOpenFlags.FullMutex, true);

            //Si ya existen las tablas NO las vuelve a crear
        ...
        public DetalleJugadorEquipoVM ObtenerDetalleJugadorEquipo(Equipo equipo, Jugador jugador)
        {
            lock (locker)
            {
                var jugadorEquipo = ObtenerJugadorEquipo(equipo.ID, jugador.ID);
                var detalle = new DetalleJugadorEquipoVM()
                {
